    ...
    <>
      ...
      <div style={{ paddingTop: '68px' }}>
        ...
        <div className="bkp-topbar"><div className="bkp-topbar-inner">
          <Link href="/car-rentals/results" className="bkp-back-btn">
        ...
        <div className="bkp-header"><div className="bkp-header-inner">
          <div className="bkp-brand">🚗 Fareoworld — Secure Car Rental Booking</div>
              ...
              <div className="bkp-card">
                ...
                <div className="bkp-card-body">
                  ...
                  <div className="bkp-actions">
                    <Link href="/car-rentals/results" className="bkp-btn-back"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M15 18l-6-6 6-6" /></svg> Change Car</Link>
              ...
              <div className="bkp-card">
                <div className="bkp-card-body" style={{ padding: '28px' }}>
                  ...
                  <div className="conf-actions">
                    ...
                    <Link href="/car-rentals/results" className="conf-btn-search" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>Search Again</Link>
                    <Link href="/car-rentals/" className="conf-btn-home" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>🏠 Home</Link>
                  </div>
                </div>
              </div>
            )}
