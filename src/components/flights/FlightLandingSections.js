    ...
    <section className="section compare-bg" ref={ref}>
      <div className="section-inner">
        <div className="section-header fade-up">
          ...
          <p>Compare flight prices across 500+ airlines in real time and book the best available fares for your journey with confidence.</p>
        </div>
...
export function WhySection() {
  const ref = useFadeUp();
  const items = [
    { icon: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" /></svg>, title: '500+ Airlines Compared', desc: 'We compare airfares from 500+ airlines including major carriers and budget airlines to find the best flight ticket prices for your route.' },
    { icon: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z" /></svg>, title: 'Price Drop Alerts', desc: 'Set fare alerts for your desired routes and get notified when cheap flight tickets or airfares drop instantly.' },
    { icon: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z" /></svg>, title: 'Free Change & Cancel Options', desc: 'Book flights with flexibility. Many fares include free changes and refund options so you can travel with confidence.' },
    { icon: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" /></svg>, title: 'Instant E-Ticket', desc: 'Get instant flight booking confirmation with e-tickets delivered to your email and saved for easy access anytime.' },
  ];
  ...
  return (
    <section className="section" style={{ background: 'var(--g50)' }} ref={ref}>
      <div className="section-inner">
        <div className="section-header fade-up">
          <div className="section-label">Why Fareoworld Flights</div>
