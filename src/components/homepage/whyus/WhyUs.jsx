...
const WHY_ITEMS = [
  {
    ...
    desc: 'We match any lower price you find within 24 hours so you always get the best airfares and flight ticket deals with confidence.',
  },
  {
    ...
    desc: 'Book flights, hotels, and travel packages in under 3 minutes with real-time availability and instant confirmation.',
  },
  {
    ...
    desc: 'Our travel experts are available around the clock to help with flight bookings, airfares, and travel queries via chat, phone, or email.',
  },
  {
    ...
    desc: 'Your payments and personal data are fully protected with bank-level SSL encryption for safe and secure flight and hotel bookings.',
  },
];
    ...
    <section className="section" style={{ background: 'var(--g50)' }} aria-labelledby="why-heading">
      <div className="section-inner">
        <div className="section-header fade-up">
          <div className="section-label">Why Fareoworld</div>
          <h2 id="why-heading">Travel Smarter, Not Harder</h2>
          <p>Find everything you need for a perfect trip including airfares, flight tickets, hotels, and travel packages in one place with zero hassle.</p>
        </div>
